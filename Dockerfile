...
LABEL org.opencontainers.image.url=https://hub.docker.com/u/conradwt/hasher-elixir
LABEL org.opencontainers.image.source=https://github.com/conradwt/hasher-elixir
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/hasher ./
